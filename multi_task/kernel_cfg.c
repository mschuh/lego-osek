...
KERNEL_CFG.C POUR 2 TACHE PERIODIQUES ET UN SEMAPHORE


- LA TACHE RAPIDE PRIORITAIRE DOIT S'APPELLER HighTask (DANS LE CODE GLUE)
- LA TACHE LENTE NON-PRIORITAIRE DOIT S'APPELLER LowTask (DANS LE CODE GLUE)
- LES PERIODE SONT A RENSEIGNER DANS periodes.h
- UN UNIQUE SEMAPHORE EST PREVU DANS CE NOYAU
  * IL EST NECESSAIRE POUR PROTEGER l'INTEGRITE DES ACCES A L'ECRAN,
    D'OU SON NOM "lcd".
  * ON PEUT BIEN SUR L'UTILISER POUR REALISER L'EXCLUSION
    DE N'IMPORTE QUEL BOUT DE CODE, MAIS C'EST UNE MAUVAISE PRATIQUE !
    (cf. le cours sur la programmation d騁erministe)
*/
...
HIGH_PERIOD, /* PERIODE RAPIDE */
LOW_PERIOD,  /* PERIODE LENTE */
};
