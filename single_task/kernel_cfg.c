...
- LA TACHE doit S'APPELLER Task1 (DANS LE CODE GLUE)
- LA PERIODE TASK1_PERIOD doit 黎re d馭inie par convention
  dans le fichier period.h 
 */
...
static __STK_UNIT _stack_Task1[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task1 ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task1, };
